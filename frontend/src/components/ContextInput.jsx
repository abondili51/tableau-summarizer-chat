  ...
  return (
    <div className="space-y-3">
      ...
      <p className="text-xs text-gray-500">
        ...
        Providing context helps the AI generate more relevant and actionable insights tailored to your specific needs. 💡 <strong>Tip:</strong> Save as Custom View to preserve your context for next time.
      </p>
    </div>
  );
}
